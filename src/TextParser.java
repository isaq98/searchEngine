...
public class TextParser {
	...
	/**
	 * Method for cleaning, splitting, and returning
	 * only the unique words found as a sorted set.
	 *
	 * @param text - the line to clean, split, and find unique words
	 * @return - sorted set of unique words
	 *
	 * @see #parse(String)
	 */
	public static TreeSet<String> uniqueWords(String line)
	{
		TreeSet<String> words = new TreeSet<>();
		Collections.addAll(words, parse(line));
		return words;
	}
}
