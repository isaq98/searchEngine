...
public class ArgumentMap {
	 ...
	 */
	public ArgumentMap() {
		this.map = new HashMap<String, String>(); // Initialize it as a hashmap
	}
	...
	public int numFlags() {
		...
		//Every key in a hashmap is unique therefore the number
		//of unique keys is the size of the map
		return map.size();
	}
	 ...
	 * @return value to which the specified flag is mapped, or {@code null} if
	...
	public Path getPath(String flag) {
		...
		//If the value is not null, return a path to it
